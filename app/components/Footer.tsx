...
export default function Footer() {
  ...
  return (
    <footer className="bg-cream border-t border-warm-dark/30 text-text-muted">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a
                ...
                aria-label="Instagram Lil' Escape"
                className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center text-accent-light hover:bg-accent-light hover:text-white transition-all duration-300"
              >
              ...
              <a
                href="https://www.tiktok.com/@lilescapecoffee"
                target="_blank"
                rel="noopener noreferrer"
                aria-label="TikTok Lil' Escape Coffee & Eatery"
                className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center text-accent-light hover:bg-accent-light hover:text-white transition-all duration-300"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                aria-label="WhatsApp Lil' Escape"
                className="w-10 h-10 bg-accent/10 rounded-full flex items-center justify-center text-accent-light hover:bg-[#25D366] hover:text-white transition-all duration-300"
              >
                <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex items-start gap-2">
                ...
                <span>Setiap hari, 10:00 - 22:00</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        {/* Bottom bar */}
        <div className="border-t border-warm-dark/30 py-6 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-text-light">
          <p>© {currentYear} Lil&apos; Escape Coffee & Eatery. Semua hak dilindungi.</p>
          <p>Dibuat dengan ☕ </p>
        </div>
      </div>
    </footer>
